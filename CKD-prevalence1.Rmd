---
title: "Gut microbiome and Chronic Kidney Disease Prevalence"
...
```{r}
#reads were filtered to detection threshold of 0.1% relative abundance, in 1% of samples
...
#beta_GFR2 <- tse %>%  mia::mergeFeaturesByRank(rank = "Species") %>% 
   ...
   #  mia::runRDA(assay.type = "relabundance",
    ...
    #                                PREVAL_DIAB.col_from_endpoints + SYSTM + BP_TREAT +
    #                                PREVAL_HFAIL_STRICT.col_from_endpoints + CURR_SMOKE +
    #                                PREVAL_AUTOIMMUN.col_from_endpoints + GFR ,
    #            distance = "bray",
